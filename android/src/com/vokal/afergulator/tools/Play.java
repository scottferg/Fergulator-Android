 ...
 */
@KeepName
public class Play implements GooglePlayServicesClient.ConnectionCallbacks, GooglePlayServicesClient.OnConnectionFailedListener {

    public static final String TAG = Play.class.getSimpleName();

    public static final StrictMode.ThreadPolicy STRICT_THREAD_POLICY = new StrictMode.ThreadPolicy.Builder()
            .detectDiskReads()
            .detectDiskWrites()
    ...
    public static final StrictMode.VmPolicy     STRICT_VM_POLICY     = new StrictMode.VmPolicy.Builder()
...
// sign-in flow.
    ...
    void debugLog(String message) {
        if (mDebugLog) {
            android.util.Log.d(mDebugTag, "GameHelper: " + message);
        }
    }

    void logWarn(String message) {
        android.util.Log.w(mDebugTag, "!!! GameHelper WARNING: " + message);
    }

    void logError(String message) {
        android.util.Log.e(mDebugTag, "*** GameHelper ERROR: " + message);
    }
...
//            int res_id = res.getIdentifier("app_id", "string", pkgName);
            return res.getString(R.string.play_services_app_id);
        } catch (Exception ex) {
            ex.printStackTrace();
...
//                        activity.finish();
    ...
    public static abstract class BaseGameActivity extends FragmentActivity implements GameHelperListener {

        // The game helper object. This class is mainly a wrapper around this object.
        protected Play mHelper;

        // We expose these constants here because we don't want users of this class
        // to have to know about GameHelper at all.
        public static final int CLIENT_GAMES    = Play.CLIENT_GAMES;
        public static final int CLIENT_APPSTATE = Play.CLIENT_APPSTATE;
        public static final int CLIENT_PLUS     = Play.CLIENT_PLUS;
        public static final int CLIENT_ALL      = Play.CLIENT_ALL;
...
//            StrictMode.setThreadPolicy(STRICT_THREAD_POLICY);
...
//            initGameServices();
        ...
        protected void initGameServices() {
            mHelper = new Play(this);
            if (mDebugLog) {
        ...
        protected Play.SignInFailureReason getSignInError() {
